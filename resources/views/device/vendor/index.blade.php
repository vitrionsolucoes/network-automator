        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-2 flex justify-center items-center mb-4">
                    <form method="get" action="{{ route('device.vendor.index') }}"
                    ...
                    <div class="m-2">
                        <a href="{{ route('device.vendor.index') }}">
                ...
                <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-6 py-4 font-medium text-gray-900">Fabricante</th>
                                <th scope="col" class="px-6 py-4 font-medium text-gray-900">Quantidade de Modelos
                                </th>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <a x-data="{ tooltip: 'Edit' }" href="/vendor/{{ $deviceVendor->id }}/edit">
                                        ...
                                        <form action="{{ route('device.vendor.destroy', $deviceVendor->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a x-data="{ tooltip: 'Delete' }" href="vendor/{{ $deviceVendor->id }}"
                                                type="submit">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="h-6 w-6"
                                                    x-tooltip="tooltip">
