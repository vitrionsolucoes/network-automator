        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-2 flex justify-center items-center mb-4">
                    <form method="get" action="{{ route('device.model.index') }}"
                    ...
                    <div class="m-2">
                        <a href="{{ route('device.model.index') }}">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <a x-data="{ tooltip: 'Edit' }" href="/model/{{ $deviceModel->id }}/edit">
                                        ...
                                        <form action="{{ route('device.model.destroy', $deviceModel->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a x-data="{ tooltip: 'Delete' }" href="model/{{ $deviceModel->id }}"
                                                type="submit">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="h-6 w-6"
                                                    x-tooltip="tooltip">
