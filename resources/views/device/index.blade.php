                ...
                <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-6 py-4 font-medium text-gray-900">Hostname</th>
                                <th scope="col" class="px-6 py-4 font-medium text-gray-900">IP</th>
                            ...
                            <tr class="hover:bg-gray-50 font-medium text-gray-700">
                                ...
                                <td>
                                    <div class="flex justify-end gap-4">
                                        <a x-data="{ tooltip: 'Edit' }" href="device/{{ $device->id }}/edit">
                                        ...
                                        <form action="{{ route('device.destroy', $device->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a x-data="{ tooltip: 'Delete' }" href="device/{{ $device->id }}"
                                                type="submit">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="h-6 w-6"
                                                    x-tooltip="tooltip">
