                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="max-w-2xl mx-auto bg-white p-16">
                        ...
                        <form action="{{ route('location.update', $location->id) }}" method="POST">
                            @csrf
                            @method('PUT') <!-- add a hidden input field to specify that the form is using the PUT method -->
                            <div class="grid gap-6 mb-6 lg:grid-cols-7">
                                <div class="lg:col-span-3 block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    ...
                                    <!-- populate the input field with the location's current name -->
                                    <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $location->name }}" required>
                                </div>
                                <div class="lg:col-span-3 block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    <label for="city">Cidade</label>
                                    <!-- populate the input field with the location's current city -->
                                    <input type="text" id="city" name="city" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $location->city }}" required>
                                </div>
